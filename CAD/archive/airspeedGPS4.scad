...
module plate(){ //top plate
	difference(){ //foot1
		translate([42.5,-21,0])cube([15,21,2]);
		translate([50,-13.5,-1])cylinder(d=6.35,19.5);
	}
	difference(){ //foot2
		translate([42.5,76,0])cube([15,21,2]);
		translate([50,89.5,-1])cylinder(d=6.35,19.5);
	}
	difference(){ //holes into cover
		cube([85,76,2]);
		translate([65,14,-0.5])cylinder(h=3,r=5);
		translate([65-5,14,-0.5])cylinder(h=3,r=3);
		translate([44,36,-0.5])cube([26.5,26.5,3]);
...
module foot(){
	...
	difference(){
		cube([15,20,16]);
		translate([7.5,7.5,-0.5])cylinder(d=6.35,19.5);
	}
}
...
translate([-4,72.5,5])rotate([0,0,180])foot();
translate([-19,-45.5,5])foot();
